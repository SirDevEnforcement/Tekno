const configs = require('../../Schemas/GuildDB');
...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (command === "add") {
            ...
            interaction.editReply({ content: `Removed \`${name}\` from your tags list.` })
            ...
            interaction.editReply({ content: `The tag with name \`${name}\` has been edited` })
