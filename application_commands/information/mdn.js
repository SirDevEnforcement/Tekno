const getSource = require('../../utils/getMdnSource');
...
module.exports = {
    ...
    run: async (client, interaction) => {
        await interaction.reply("Fetching the data - This usually takes 5 seconds");
        ...
        if (search?.length === 0) interaction.editReply("Search not found");
            ...
            interaction.editReply({
                embeds: [{
                    ...
                    color: 0x83BFFF,
                    title: `Search for: ${interaction.options.getString('query')}`,
