...
const polls = require("../../Schemas/PollsDB")
        ...
        if (option === "create") {
            ...
            if (rawOptions.length < 2 || rawOptions.length > 25) return interaction.editReply({
                embeds: [{
                    ...
                    description: "You need at least 2 options! Seperate them with `|`!"
                }]
            });
            ...
            if (poll.ended) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ The poll has already been ended!",
                }]
            });
            ...
            if (!msg) return interaction.editReply({
                embeds: [{
                    color: "RED",
                    title: "❌ The poll cannot be ended!",
                    description: `The poll message was deleted, so I can't end the poll!`
                }]
            });
